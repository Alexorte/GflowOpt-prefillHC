...
from dag_gflownet.utils.hc_metrics import summarize_hc_final_results, save_hc_final_metrics
# 导入学习率调度器
try:
...
def optimize_with_proxy(args):
    ...
    hc_final_metrics, hc_results_summary = summarize_hc_final_results(diverse_top_results, graph, data_train, data_test, equivalent_sample_size=1.0)

    save_hc_final_metrics(Path(args.output_dir), hc_final_metrics, hc_results_summary)
