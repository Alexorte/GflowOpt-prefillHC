...
def main(args):
    ...
    data_train, data_test = train_test_split(data,test_size=0.2,random_state=args.seed,shuffle=True)
    ...
    results = {
        ...
        **mll_results,
        ...
        "total_time_seconds": float(training_time + eval_time),
    }
...
if __name__ == '__main__':
    ...
    zenodo.add_argument('--network', type=str, required=True)
    zenodo.add_argument('--sample_id', type=int, required=True)
